...
- база данных MySQL:
  - используем стабильный образ `percona/percona-server:8.0.43` / `percona/percona-server:8.4.5`
  - добавляем слоем сверху конфигурацию бд
  - собираем `bitrix24/percona-server:8.0.43-v1-rhel` / `bitrix24/percona-server:8.4.5-v1-rhel`
- веб-сервер:
